...
namespace CBApp.Migrations
{
    ...
    [Migration("20230302153150_AddDeactivateBoolToUser")]
    partial class AddDeactivateBoolToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBApp.Models.CSInterest", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.CSInterestUser", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.CareerPhase", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.ExperienceLevel", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.Gender", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.Hobby", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.HobbyUser", b =>
                {
                    b.Property<string>("SlackId")
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("SlackId");
            ...
            modelBuilder.Entity("CBApp.Models.Likes", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.NaturalLanguage", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.NaturalLanguageUser", b =>
                {
                    b.Property<string>("SlackId")
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("SlackId");
            ...
            modelBuilder.Entity("CBApp.Models.ProgrammingLanguage", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.ProgrammingLanguageUser", b =>
                {
                    b.Property<string>("SlackId")
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("SlackId");
            ...
            modelBuilder.Entity("CBApp.Models.Question", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.QuestionAnswerBlock", b =>
                {
            ...
            modelBuilder.Entity("CBApp.Models.Rejections", b =>
                {
                    b.Property<string>("SlackId1")
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("CBApp.Models.User", b =>
                {
                    b.Property<string>("SlackId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("DeactivateRequest")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CBApp.Models.CSInterestUser", b =>
                {
                    b.HasOne("CBApp.Models.CSInterest", "CSInterest")
                        .WithMany("CSInterestUsers")
                        .HasForeignKey("CSInterestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CBApp.Models.User", "User")
                        .WithMany("CSInterestUsers")
            ...
            modelBuilder.Entity("CBApp.Models.HobbyUser", b =>
                {
                    b.HasOne("CBApp.Models.Hobby", "Hobby")
                        .WithMany("HobbyUsers")
            ...
            modelBuilder.Entity("CBApp.Models.Likes", b =>
                {
                    b.HasOne("CBApp.Models.User", "User1")
                        .WithMany("UsersLiked")
                        .HasForeignKey("SlackId1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CBApp.Models.User", "User2")
                        .WithMany("LikedBy")
            ...
            modelBuilder.Entity("CBApp.Models.NaturalLanguageUser", b =>
                {
                    b.HasOne("CBApp.Models.NaturalLanguage", "NaturalLanguage")
            ...
            modelBuilder.Entity("CBApp.Models.ProgrammingLanguageUser", b =>
                {
                    b.HasOne("CBApp.Models.ProgrammingLanguage", "ProgrammingLanguage")
            ...
            modelBuilder.Entity("CBApp.Models.User", b =>
                {
                    b.HasOne("CBApp.Models.CareerPhase", "CareerPhase")
                        .WithMany("Users")
                        .HasForeignKey("CareerPhaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CBApp.Models.ExperienceLevel", "ExperienceLevel")
                        .WithMany("Users")
                        .HasForeignKey("ExperienceLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CBApp.Models.Gender", "Gender")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CBApp.Models.User", null)
                        .WithMany()
